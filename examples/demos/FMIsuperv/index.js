...
require([ "plugins/FMI/PBFMIPVSPrinter" ], function (PBFMIPVSPrinter) {
    ...
    var statevariables = [
		...
		{name:"monitor", type:"string",variability: "discrete", scope:"input", value:"0",top:20, left: 500, width: 300, widget: "BasicDisplay"},
		{name:"pump", type:"string",variability: "discrete", scope:"input", value:"0",top:20, left: 500, width: 300, widget: "BasicDisplay"},
	...
	var fmi = {name: "Supervisor", state_variables : {variables: statevariables}, };
	
	var fmi_composed = {name: "Radical7", composed_variables : {variables: composedvariables},}
