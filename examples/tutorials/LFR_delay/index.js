...
require([ 	"plugins/FMI/PBFMIPVSPrinter"
	...
	{name: "left", parent:"motorSpeedIn", type:"Real", variability: "discrete", scope: "input", value: "0"},
	{name: "right",parent:"motorSpeedIn", type:"Real", variability: "discrete", scope: "input", value: "0"},
	{name: "left", parent:"motorSpeedOut", type:"Real", variability: "discrete", scope: "output", value: "0"},
	{name: "right",parent:"motorSpeedOut", type:"Real", variability: "discrete", scope: "output", value: "0"}
    ...
    fmi_module.create_FMU("LFR_delay",{state_variables : {variables: statevariables},composed_variables : {variables: composedvariables},init:"init_state",tick:"tick",port:"8084"});
