...
require([ "plugins/FMI/PBFMIPVSPrinter" ], function (PBFMIPVSPrinter) {
    ...
    var statevariables = [
		...
		{name:"rra_fail", type:"Boolean",variability: "discrete", scope:"output", value:"0",top:1220, width: 300, widget: "BasicDisplay"},
    ...
    printer.create_FMU("Radical7",{state_variables : {variables: statevariables},composed_variables : {variables: composedvariables},init:"init(0)",tick:"tick",port:"8086"});
});
