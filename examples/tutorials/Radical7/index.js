...
require([ "plugins/FMI/PBFMIPVSPrinter" ], function (PBFMIPVSPrinter) {
    ...
    var statevariables = [
		...
		{name:"spo2", type:"real",variability: "continuous", scope:"output", value:"0",top:120, width: 300, widget: "BasicDisplay"},
		{name:"spo2_max", type:"real",variability: "continuous", scope:"output", value:"0",top:220, width: 300, widget: "BasicDisplay"},
		{name:"spo2_min", type:"real",variability: "continuous", scope:"output", value:"0",top:320, width: 300, widget: "BasicDisplay"},
		{name:"spo2_label", type:"string",variability: "continuous", scope:"output", value:"0",top:420, width: 300, widget: "BasicDisplay"},
		{name:"spo2_alarm", type:"string",variability: "continuous", scope:"output", value:"0",top:520, width: 300, widget: "BasicDisplay"},
		{name:"spo2_fail", type:"bool",variability: "continuous", scope:"output", value:"0",top:620, width: 300, widget: "BasicDisplay"},
		{name:"rra", type:"real",variability: "continuous", scope:"output", value:"0",top:720, width: 300, widget: "BasicDisplay"},
		{name:"rra_max", type:"real",variability: "continuous", scope:"output", value:"0",top:820, width: 300, widget: "BasicDisplay"},
		{name:"rra_min", type:"real",variability: "continuous", scope:"output", value:"0",top:920, width: 300, widget: "BasicDisplay"},
		{name:"rra_label", type:"string",variability: "continuous", scope:"output", value:"0",top:1020, width: 300, widget: "BasicDisplay"},
		{name:"rra_alarm", type:"string",variability: "continuous", scope:"output", value:"0",top:1120, width: 300, widget: "BasicDisplay"},
		{name:"rra_fail", type:"bool",variability: "continuous", scope:"output", value:"0",top:1220, width: 300, widget: "BasicDisplay"},
		{name:"isOn", type:"bool",variability: "continuous", scope:"output", value:"0",top:1320, width: 300, widget: "BasicDisplay"},
    ...
    printer.print(fmi,[btn_on]);
    printer.print_front(fmi,[btn_on]);
});
