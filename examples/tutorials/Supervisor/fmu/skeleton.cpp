...
void doStep() { 	
    ...
    index_state=findVariable("monitor",state);
    if ( index_state != -1){
		index_state1=findVariable("HR ", &state[index_state]);
    ...
    index_state=findVariable("monitor",state);
    if ( index_state != -1){
		index_state1=findVariable("HR_max", &state[index_state]);
    ...
    index_state=findVariable("monitor",state);
    if ( index_state != -1){
		index_state1=findVariable("HR_min", &state[index_state]);
    ...
    index_state=findVariable("monitor",state);
    if ( index_state != -1){
		index_state1=findVariable("HR_fail", &state[index_state]);
    ...
    index_state=findVariable("monitor",state);
    if ( index_state != -1){
		index_state1=findVariable("HR_label", &state[index_state]);
    ...
    index_state=findVariable("monitor",state);
    if ( index_state != -1){
		index_state1=findVariable("HR_alarm", &state[index_state]);
