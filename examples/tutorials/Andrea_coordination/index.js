...
require([ "plugins/FMI/PBFMIPVSPrinter" ], function (PBFMIPVSPrinter) {
    ...
    var statevariables = [
		{name:"timesteps", type: "Real", variability: "discrete", scope:"output", value: "0"}		
	];
	
	var composedvariables = [
		{name:"prec", parent:"st", type: "Real", variability: "discrete", scope:"input", value: "0"},		
		{name:"self", parent:"st", type: "Real", variability: "discrete", scope:"output", value: "0"},		
		{name:"foll", parent:"st", type: "Real", variability: "discrete", scope:"input", value: "0"},		
		{name:"id", parent:"st", type: "Real", variability: "tunable", scope:"parameter", value: "0"}		
	];
	
    var printer = new PBFMIPVSPrinter();
    printer.create_FMU("x_coverage",{state_variables : {variables: statevariables},composed_variables : {variables: composedvariables},init:"initial",tick:"fmi_tick",port:"8084"});
