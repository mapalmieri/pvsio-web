...
require([ "plugins/FMI/PBFMIPVSPrinter" ], function (PBFMIPVSPrinter) {
    ...
    var statevariables = [
		...
		{name : "out1", type: "real", variability: "discrete", scope:"output", value:"0"},
		{name : "out2", type: "real", variability: "discrete", scope:"output", value:"0"},
		{name : "out3", type: "real", variability: "discrete", scope:"output", value:"0"},
		{name : "out4", type: "real", variability: "discrete", scope:"output", value:"0"},
		...
		{name : "backwardRotate", type: "real", variability: "fixed", scope:"parameter", value:"0.1"},
		{name : "forwardRotate", type: "real", variability: "fixed", scope:"parameter", value:"0.5"},
		{name : "forwardSpeed", type: "real", variability: "fixed", scope:"parameter", value:"0.4"},
		
		{name : "mode", type: "string", variability: "discrete", scope:"output", value:"Auto"},
		{name : "previous_mode", type: "string", variability: "discrete", scope:"output", value:"Auto"},
    ...
    fmi_module.create_FMU("line_following_robot_arduino",{state_variables : {variables: statevariables},composed_variables : {variables: composedvariables},init:"init",tick:"tick",port:"8084"});
